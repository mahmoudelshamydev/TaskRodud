        ...
        if(!$user_id)
        {
            ...
            if($send_to == "users"){
                ...
                foreach($users as $user )
                {
                    ...
                    $notificationBuilder = new PayloadNotificationBuilder('TireShop - '.$title_notification);
            ...
            if($send_to == "guest"){
                ...
                $guests = Requests::select("device_token")->whereNull('user_id')->distinct()->get();
